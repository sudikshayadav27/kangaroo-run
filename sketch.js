...
function setup() {
  ...
  jungle = createSprite(400,100,800,200);
...
*/
kangaroo = createSprite(10,100,10,10);
...
invisibleGround = createSprite(400,330,800,20);
...
camera.position.x = kangaroo.x;
   ...
   console.log(kangaroo.y)
    ...
    if(keyDown("space")&& kangaroo.y>230) {
      jumpSound.play();
...
function spawnShrubs() {
  //write code here to spawn the shrubs

  if (frameCount % 150 === 0) {
shrub = createSprite(camera.position.x + 400,330,10,10)
